...
class InfectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create infection" do
    assert_difference('Infection.count') do
      post infections_url, params: { infection: { animal_id: @infection.animal_id, date_of_infection: @infection.date_of_infection, disease_id: @infection.disease_id } }
    end
  ...
  test "should update infection" do
    patch infection_url(@infection), params: { infection: { animal_id: @infection.animal_id, date_of_infection: @infection.date_of_infection, disease_id: @infection.disease_id } }
